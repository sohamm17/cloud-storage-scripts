...
labels = [#"UBC to GoogleDrive (Direct)", "UBC to Coldlake", "Coldlake to GoogleDrive", "UBC to UMich", "UMich to GoogleDrive", 
	"UBC to One Drive (Direct)", "UBC to UMich", "UMich to One Drive", "UBC to One Drive (UMich-cut-through)",
	#"UBC to OneDrive (Direct)", "UBC to Coldlake", "Coldlake to OneDrive", "UBC to UMich", "UMich to OneDrive"
	]
stream = 'upload'
bar_width = 0.50
...
for filesz in x:
	values = []
	with open("../GoogleDriveInterUBCToUMich.txt") as f:
		for line in f:
			lineValues = line.strip().split(' ')
			if (int)(lineValues[0]) != filesz:
				continue
...
for filesz in x:
	values = []
	with open("../GoogleDriveInterNodeUBCUMich.txt") as f:
		for line in f:
			lineValues = line.split('\t')
			if lineValues[2] != stream or (int)(lineValues[1]) != filesz:
				continue
...
for filesz in x:
	values = []
	with open("OneDirectUMich.txt") as f:
		for line in f:
			lineValues = line.split('\t')
			if lineValues[2] != stream or (int)(lineValues[1]) != filesz:
				continue
...
for filesz in x:
	values = []
	with open("OneUMichInter.txt") as f:
		for line in f:
			lineValues = line.strip().split(' ')
			if (int)(lineValues[0]) != filesz:
				continue
...
for filesz in x:
	values = []
	with open("OneUMichInterWorm.txt") as f:
		for line in f:
			lineValues = line.strip().split(' ')
			if (int)(lineValues[0]) != filesz:
				continue
...
for filesz in x:
	values = []
	with open("OneUMichInter_UBC.txt") as f:
		for line in f:
			lineValues = line.strip().split(' ')
			if (int)(lineValues[0]) != filesz:
				continue
...
for filesz in x:
	values = []
	with open("OneUMichRemoteUBC.txt") as f:
		for line in f:
			lineValues = line.split('\t')
			if lineValues[2] != stream or (int)(lineValues[1]) != filesz:
				continue
...
#plt.show()
plt.savefig("./ubc_one_cut_umich.pdf", bbox_inches='tight', dpi=60000)
